...
public class LoginStepDefination {
	...
	public void title_of_login_page_is(String title) throws Throwable {
		String title1 = lp.login_Title_page();
	  Assert.assertEquals(title, title1);
	}
	@Then("^user enter \"([^\"]*)\" and \"([^\"]*)\"$")
	public void user_enter_username_and_password(String a,String b) throws Throwable {
	...
	public void user_moves_to_a_new_contact_page()  {
	   lp.ContactPage_Test();
	}

	@Then("^user enter \"([^\"]*)\",\"([^\"]*)\" and \"([^\"]*)\"$")
	public void user_enter_and(String arg1, String arg2, String arg3) {
